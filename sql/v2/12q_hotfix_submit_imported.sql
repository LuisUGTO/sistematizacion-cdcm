...
-- 12q_hotfix_submit_imported.sql
-- Etapa 6.6.3: corrige el envío de borradores manuales e importados
...
--   - Se permite el origen IMPORTACION_EXCEL, manteniendo MIGRACION_V1 en
--     modo histórico de solo lectura.
-- ============================================================================
...
BEGIN
  IF to_regclass('v2.registros') IS NULL
    ...
    RAISE EXCEPTION
      'PRECONDICION_FALLIDA: instale primero 12d_draft_workflow.sql.';
  END IF;
END
$$;
...
VALUES (
  '2.1.12q',
  '12q_hotfix_submit_imported.sql - Corrige ambigüedad y habilita el envío seguro de BORRADOR importado.'
)
